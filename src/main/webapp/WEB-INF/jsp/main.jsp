            ...
            <ul class="nav" id="side-menu">
                        ...
                        <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                                <span class="clear">
                                    <span class="block m-t-xs" style="font-size:20px;">
                                        <strong class="font-bold">i创创业社团管理</strong>
                                    </span>
                                </span>
                        </a>
                    </div>
                ...
                <li>
                    ...
                    <ul class="nav nav-second-level">
                        ...
                        <li>
                            <a class="J_menuItem" href="graph_morris.html">社团信息管理</a>
                        </li>
                        <li>
                            <a class="J_menuItem" href="graph_rickshaw.html">部门信息管理</a>
                        </li>
                        <li>
                            <a class="J_menuItem" href="graph_peity.html">普通社员信息管理</a>
                        </li>
                        <li>
                            <a class="J_menuItem" href="graph_sparkline.html">社团管理者信息管理</a>
                        </li>
                        <li>
                            <a class="J_menuItem" href="graph_metrics.html">指导老师信息管理</a>
                        </li>
                    </ul>
                </li>
                <li class="line dk"></li>
                ...
                <ul class="nav navbar-top-links navbar-right">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-user">
                            <li>
                                <a class="J_menuItem" href="${pageContext.request.contextPath }/toAdminInfo.action">
                                    <i class="fa fa-user fa-fw"></i>
